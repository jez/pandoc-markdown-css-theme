...
:::{.note .yellow}
------------------------------------------------------------------------
👋 This page is designed to look similar to Tufte CSS, powered by the
customization features in [Pandoc Markdown CSS Theme](..).

[→ More information on Tufte CSS](https://edwardtufte.github.io/tufte-css/)
------------------------------------------------------------------------
...
gem 'sorbet-runtime'
```
<figcaption>`Gemfile` contents</figcaption>
</figure>
